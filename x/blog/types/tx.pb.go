...
type MsgDeletePostResponse struct {
	ReturnValue string `protobuf:"bytes,1,opt,name=returnValue,proto3" json:"returnValue,omitempty"`
}
...
func (m *MsgDeletePostResponse) GetReturnValue() string {
	if m != nil {
...
var fileDescriptor_35732e905b6dd4b9 = []byte{
	...
	,
}
...
func (m *MsgDeletePostResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReturnValue) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.ReturnValue)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
